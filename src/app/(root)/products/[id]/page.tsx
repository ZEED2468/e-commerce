...
export default async function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-15">
      ...
      <section className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:mt-15 sm:mt-15">
        ...
        <div className="flex flex-col gap-6 lg:mt-15">
          ...
          <div className="flex flex-col gap-3">
            <button className="flex items-center justify-center gap-2 rounded-full bg-dark-900 px-4 py-4 min-w-fit max-w-xs text-body-medium text-light-100 transition hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[--color-dark-500]">
              Add to Cart
            </button>
          </div>
        </div>
